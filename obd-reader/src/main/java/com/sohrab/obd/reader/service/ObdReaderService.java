...
public class ObdReaderService extends IntentService implements DefineObdReader {
    ...
    private FileOutputStream fosExt = null;
    private File fileExt = null;
...
*/
    ...
    public void salvaLog(){
        ...
        if(fileExt == null){
            fileExt = new File(diretorioApp, "log-obd-error.txt");
        }
    ...
    private void executeCommand() {
        ...
        while (mSocket != null && mSocket.isConnected() && commands.size() > count && isConnected && ObdPreferences.get(getApplicationContext()).getServiceRunningStatus()) {
            ...
            try {
                ...
                log = "command run :: " + command.getName()+ "  ";
                //salvaLog();
                ...
                log = "execute command Exception  :: " + e.getMessage() +" ";
                //salvaLog();
...
*/
    ...
    public void onDestroy() {
        ...
        //Obrigatoriamente você fecha arquivo log
